/*! For license information please see main.e342a49a.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        var Va = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = Ma(e, a, l)) && (ts(n, e, l, r), Da(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = Ma(e, l, r)) && (ts(n, e, r, t), Da(n, e, r));
          },
        };
        ...
        function Mo(e, n, t, r) {
          (n.value = t), (n.getSnapshot = r), Fo(n) && jo(e);
        }
        function Do(e, n, t) {
          return t(function () {
            Fo(n) && jo(e);
        ...
        function zu(e, n, t, r, l, a) {
          Cu(e, n);
          var o = 0 !== (128 & n.flags);
          if (!r && !o) return l && jl(n, t, !1), Hu(e, n, a);
        ...
        var xi,
          ...
          Zi = 0;
        function es() {
          return 0 !== (6 & Pi) ? Ge() : -1 !== Ji ? Ji : (Ji = Ge());
        }
        function ns(e) {
          return 0 === (1 & e.mode)
            ? 1
        ...
        function ls(e, n) {
          if (((Ji = -1), (Zi = 0), 0 !== (6 & Pi))) throw Error(a(327));
          var t = e.callbackNode;
        ...
        function cs(e) {
          ...
          try {
            ...
            (wn = r), (Ni.transition = t), 0 === (6 & (Pi = n)) && $l();
          }
        }
        function fs() {
          (Oi = Ri.current), _l(Ri);
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Pi = t), (_i.current = r), null !== Ti))
            throw Error(a(261));
        ...
        function Ss() {
          if (null !== Ki) {
            var e = kn(Yi),
              ...
              t = wn;
            try {
              if (((Ni.transition = null), (wn = 16 > e ? 16 : e), null === Ki))
                var r = !1;
              else {
        ...
        function Hs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Ma(l, n, o)) && (ts(e, l, o, a), Da(e, l, o)),
            o
          );
        }
        function Ws(e) {
  ...
  !(function () {
    ...
    var o = t(791),
      ...
      i = function (e) {
        return (0, u.jsx)("div", {
          ...
          children: (0, u.jsxs)("div", {
            ...
            children: [
              (0, u.jsx)("label", { children: "Filter by year" }),
              (0, u.jsxs)("select", {
                value: e.selected,
                onChange: function (n) {
                ...
                children: [
                  (0, u.jsx)("option", { value: "2022", children: "2022" }),
                  (0, u.jsx)("option", { value: "2021", children: "2021" }),
                  (0, u.jsx)("option", { value: "2020", children: "2020" }),
                  (0, u.jsx)("option", { value: "2019", children: "2019" }),
                ],
              }),
            ],
          }),
      ...
      s = function (e) {
        var n = e.date.toLocaleString("en-US", { day: "2-digit" }),
          t = e.date.toLocaleString("en-US", { month: "long" }),
      ...
      c = function (e) {
        return (0, u.jsxs)("div", {
          ...
          children: [
            (0, u.jsxs)("h2", { children: [" ", e.expense.title, " "] }),
            (0, u.jsxs)("div", {
              className: "expense-item__location",
              children: [" ", e.expense.location, " "],
            }),
            (0, u.jsxs)("div", {
              className: "expense-item__price",
              children: [" $", e.expense.amount, " "],
            }),
          ],
        });
      },
      f = function (e) {
        var n = "card " + e.className;
        return (0, u.jsxs)("div", {
          className: n,
          children: [" ", e.children, " "],
        });
        ...
        return 0 === e.items.length
          ...
          : (0, u.jsx)("ul", {
              ...
              children: e.items.map(function (e) {
                return (0,
                u.jsx)(d, { title: e.title, amount: e.amount, date: e.date }, e.id);
              }),
            });
      };
    var m = function (e) {
        ...
        return (
          e.maxValue > 0 &&
            (n = Math.round((e.value / e.maxValue) * 100) + "%"),
          (0, u.jsxs)("div", {
            className: "chart-bar",
            children: [
              (0, u.jsx)("div", {
      ...
      h = function (e) {
        var n = e.dataPoints.map(function (e) {
            return e.value;
          }),
          t = Math.max.apply(Math, l(n));
        return (0, u.jsx)("div", {
          className: "chart",
          children: e.dataPoints.map(function (e) {
            return (0,
            u.jsx)(m, { value: e.value, maxValue: t, label: e.label }, e.label);
          }),
        });
      },
      v = function (e) {
        ...
        try {
          for (l.s(); !(n = l.n()).done; ) {
            var a = n.value;
            t[a.date.getMonth()].value += a.amount;
          }
        } catch (o) {
          l.e(o);
        } finally {
        ...
        return (0, u.jsx)(h, { dataPoints: t });
      },
      g = function (e) {
        var n = a((0, o.useState)("2020"), 2),
          t = n[0],
          r = n[1],
          l = e.items.filter(function (e) {
            return e.date.getFullYear().toString() === t;
          });
        return (0, u.jsx)("div", {
          children: (0, u.jsxs)(f, {
            className: "expenses",
    ...
    var x = function (e) {
        ...
        return (0, u.jsxs)("form", {
          onSubmit: function (n) {
            n.preventDefault();
            var l = { title: t, amount: +i, date: new Date(f) };
            e.onSaveExpenseData(l), r(""), s(""), d("");
          },
          children: [
            (0, u.jsxs)("div", {
      ...
      E = function (e) {
        ...
        return (0, u.jsxs)("div", {
          ...
          children: [
            ...
            t &&
              (0, u.jsx)(x, {
                onSaveExpenseData: function (n) {
                  var t = S(S({}, n), {}, { id: Math.random().toString() });
                  e.onAddExpense(t), r(!1);
                },
                onCancel: function () {
                  r(!1);
                },
      ...
      C = function () {
        var e = a((0, o.useState)(_), 2),
          n = e[0],
          t = e[1];
        return (0, u.jsxs)("div", {
          children: [
            (0, u.jsx)(E, {
              onAddExpense: function (e) {
                t(function (n) {
                  return [e].concat(l(n));
                });
              },
    ...
    e.createRoot(document.getElementById("root")).render((0, u.jsx)(C, {}));
  })();
})();
//# sourceMappingURL=main.e342a49a.js.map
